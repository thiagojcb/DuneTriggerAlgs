...
namespace triggeralgs {
  ...
  protected:
    ...
    std::atomic<uint16_t> m_threshold     = {3};             /// Minimum number of activities in the time window to issue a trigger
    std::atomic<uint16_t> m_hit_threshold = {2};             /// Minimum number of primities in an activity
